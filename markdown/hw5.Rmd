...
# county for Boston is Suffolk County 25_025
...
boston_homicides <- st_as_sf(ma_homicides, coords = c("lon", "lat")) %>%
  st_set_crs(4269)
```
...
```{r boston plot, fig.height=6, fig.width=9.5}
# map plot of Boston homicides (Suffolk County)
ggplot() +
